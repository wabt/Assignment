...
public class PasswordServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String oldPasswordSha1 = Encrypt.toSHA1(oldPassword);
        HttpSession session = request.getSession();
        ...
        if(!oldPasswordSha1.equals(u.getPassword())){
            request.setAttribute("error", "Wrong Old Password!");
            request.getRequestDispatcher("password.jsp").forward(request, response);
        }else{
            String passwordSha1 = Encrypt.toSHA1(password);
            u.setPassword(passwordSha1);
            DAO d = new DAO();
            d.changePassword(u);
