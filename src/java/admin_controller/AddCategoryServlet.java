...
public class AddCategoryServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        request.getRequestDispatcher("a_addcategory.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        Category c = new Category(categoryName, categoryImage);
        if(cdb.getCategoryByName(categoryName)==null){
            cdb.insert(c);
