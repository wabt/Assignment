<%-- 
    Document   : signup
    Created on : Mar 2, 2024, 7:12:37 PM
    Author     : Admin
--%>
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100 p-t-85 p-b-20">
                <form action="verify" method="post" class="login100-form validate-form">
                    <!--                    <span class="login100-form-title p-b-70">
                                            Welcome
                                        </span>-->
                    <div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate="Enter E-Mail">
                        <input onkeyup="checkEmail(this)" class="input100 has-val" required type="text" name="email">
                    ...
                    <div class="wrap-input100 validate-input m-b-50" data-validate="Enter username">
                        <input class="input100 has-val" required type="text" name="username">
                        <span class="focus-input100" data-placeholder="Username"></span>
                    </div>
                    <div class="wrap-input100 validate-input m-b-50" data-validate="Enter password">
                        <input class="input100 has-val" required type="password" name="pass">
                        <span class="focus-input100" data-placeholder="Password"></span>
                    </div>
                    <h5 class="input100" style="color: red">${requestScope.error}</h5>
                    <h5 class="input100" style="color: red">${requestScope.existed}</h5>
                    <h5 class="input100" style="color: red">${requestScope.verify}</h5>
